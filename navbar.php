...
<!-- Navigation-->
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
					<img src="assets/recycle.ico" width="30px" height="30px" alt="Icon Description"> &emsp;
                    <a class="navbar-brand" href="index.php"><span class="fw-bolder text-primary">EcoRecyclePenang</span></a>
